package cn.a10miaomiao.bbmiao.widget.player
...
//    }
    ...
    fun setAutoStopTimerOnClickListener(l: OnClickListener) {
        mAutoStopTimerTV.setOnClickListener(l)
    }
    ...
    override fun showProgressDialog(
        ...
        if (mProgressDialog == null) {
            ...
            mProgressDialog = Dialog(activityContext, com.shuyu.gsyvideoplayer.R.style.video_style_dialog_progress)
    ...
    override fun showBrightnessDialog(percent: Float) {
        if (mBrightnessDialog == null) {
            ...
            mBrightnessDialog = Dialog(activityContext, com.shuyu.gsyvideoplayer.R.style.video_style_dialog_progress)
