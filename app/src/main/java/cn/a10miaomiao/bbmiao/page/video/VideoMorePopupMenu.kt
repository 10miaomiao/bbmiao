...
import cn.a10miaomiao.bbmiao.page.download.DownloadVideoCreateParam
...
class VideoMorePopupMenu(
    ...
    private fun Menu.initMenu() {
        val detailInfo = viewModel.arcInfo
            ...
            11 -> {
                ...
                if (info != null) {
                    ...
                    if (current != -1) {
                        playListStore.run {
                            addItem(
                                info.toPlayListItem(viewModel.pages),
                                current + 1
                            )
                        }
