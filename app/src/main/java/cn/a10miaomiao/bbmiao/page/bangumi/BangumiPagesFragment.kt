...
//    private val viewModel by diViewModel<TemplateViewModel>(di)
    ...
    val itemUi = miaoBindingItemUi<BangumiPagesParam.Episode> { item, index ->
        verticalLayout {
            setBackgroundResource(cn.a10miaomiao.bbmiao.R.drawable.shape_corner)
            ...
            views {
                ...
                +textView {
                    textColorResource = cn.a10miaomiao.bbmiao.R.color.text_black
                    ...
                    _textColorResource = if (isSelect) {
                        ...
                        cn.a10miaomiao.bbmiao.R.color.text_black
                    }
