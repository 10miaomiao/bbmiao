...
class PreferenceScreen private constructor(builder: Builder) : Preference(builder.key) {
    ...
    class Builder private constructor(
        ...
        key: String =  KEY_ROOT_SCREEN,
        // 添加
        internal val prefs: SharedPreferences? = null,
    ) : AbstractPreference(key), Appendable {

        constructor(
            context: Context?,
            prefs: SharedPreferences? = null
        ) : this(context, KEY_ROOT_SCREEN, prefs)
        constructor(
            builder: Builder,
            key: String = "",
        ) : this(builder.context, key, builder.prefs)
        constructor(
            collapse: CollapsePreference,
            key: String = ""
        ) : this(collapse.screen?.context, key, collapse.screen?.prefs)
