...
// PreferenceScreen DSL functions
inline fun screen(context: Context?, prefs: SharedPreferences, block: PreferenceScreen.Builder.() -> Unit): PreferenceScreen {
    return PreferenceScreen.Builder(context, prefs = prefs).apply(block).build()
}
